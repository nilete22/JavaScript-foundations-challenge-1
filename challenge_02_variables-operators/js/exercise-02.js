...
console.log(HelloJaume);

/*Repeat the above steps but try using a const variable. Comment this new part of code and explain what is happening.*/
// explication:
/*When you declare a variable const you need to asign a value in the declaration line,
because if not the variable is declarated with undefined and its a const variable we cant change the value.
*/
